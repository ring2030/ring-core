...
const PATIENTS: Patient[] = [
  // senderNames must include every alias the device / seed writes into Firestore.
  // Real tablets send as "清子"; seed writes "清子" after the 2026-05-10 update.
  { id: "kiyoko",   name: "荒井 清子 (Kiyoko)",   room: "101", age: 82, condition: "Alzheimer's disease", senderNames: ["清子", "Kiyoko", "kiyoko", "Kiyoko Arai"] },
  { id: "taro",     name: "村瀬 太郎 (Taro)",     room: "102", age: 78, condition: "Lewy body dementia",   senderNames: ["太郎", "Taro",  "tome",   "Taro Murase"] },
  { id: "hanako",   name: "宮北 花子 (Hanako)",    room: "103", age: 85, condition: "Vascular dementia",   senderNames: ["花子", "Hanako","hanako", "Hanako Miyakita"] },
  { id: "hidefumi", name: "横内 秀文 (Hidefumi)",  room: "104", age: 80, condition: "Recovery / general care", senderNames: ["秀文", "ひでふみ", "Hidefumi", "hidefumi", "横内秀文", "Yokouchi Hidefumi"] },
];
